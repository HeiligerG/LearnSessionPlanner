...
> **🤖 This entire project was created with AI assistance - not a single line was written manually.**
...
This project is **100% open source** and was created entirely using AI (Claude Code). Every single line of code, from the backend API to the frontend UI, was generated through AI collaboration.

### Creator's Note

> *"Es scheint erst widersprüchlich, einen Lernsession-Planer, der dem Lernen dient, gänzlich mit KI zu erstellen. Jedoch ist dies genau so ein Lernprozess: Die Welt der KI zu erkunden und ihre Grenzen zu testen und ebenso gleich etwas Nützliches zu erstellen, wie es das Erlernen einer neuen Programmiersprache dient – wenn in der heutigen Welt nicht sogar manchmal wertvoller."*

This quote is the only original content written by the project creator. Everything else, including this README, was generated by AI.
